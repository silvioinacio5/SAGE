...
@section('content')
    ...
    <div class="page-title">                    
        <h2><a href="{{url('http://localhost/SAGE/home')}}" class="fa fa-arrow-circle-o-left"></a>Cadastrar-se como Candidato</h2>
    </div>
    <!-- END PAGE TITLE -->                
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Formulário</strong> de Cadastro</h3>
                        ...
                        <div class="panel-body">                                                                        
                            ...
                            <div class="form-group">                                        
                                <label class="col-md-3 col-xs-12 control-label">Nível Acadêmico</label>
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-map-marker"></span></span>
                                        <input type="text" name="education_level" required value="{{old('education_level')}}" class="form-control"/>
                                    </div>            
                                </div>
                            </div>
                            ...
                            <div class="form-group">                                        
                                <label class="col-md-3 col-xs-12 control-label">Morada</label>
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-map-marker"></span></span>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 col-xs-12 control-label">Curriculum Vitae</label>
                                <div class="col-md-6 col-xs-12">                                            
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="fa fa-user"></span></span>
