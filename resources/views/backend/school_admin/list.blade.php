...
@section('content')
    ...
    <ul class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li class="active">Admin Escola</li>
    </ul>
    <!-- END BREADCRUMB -->
    
    <!-- PAGE TITLE -->
    <div class="page-title">                    
        <h2><a href="{{ url('/panel/dashboard') }}" class="fa fa-arrow-circle-o-left"></a>Admin Escola</h2>
    </div>
    <!-- END PAGE TITLE -->                
    ...
    <div class="page-content-wrap">
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Pesquisar Admin Escola</h3>
                    </div>
                    ...
                    <form action="" method="get">
                        ...
                        <div class="col-md-12">
                            ...
                            <a href="{{url('panel/school_admin')}}" class="btn btn-success">Formatar</a>
                        </div>
                    </form>
                    </div>
                </div>                                                
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Lista Admin Escola</h3>
                        <a href="{{url('panel/school_admin/create')}}" class="btn btn-success pull-right">Cadastrar Admin Escola</a>
                    </div>
                                    ...
                                    @forelse($getAdmin as $value)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a onclick="return confirm('Deletar?');" href="{{url('panel/school_admin/delete/'.$value->id)}}" class="btn btn-danger btn-rounded btn-sm" onClick="delete_row('trow_1');"><span class="fa fa-times"></span></a>
                                            </td>
                                        </tr>  
                                        @empty
                                            <tr>
