...
@section('content')
    ...
    <div class="page-title">                    
        <h2><a href="{{url('http://localhost/SAGE/panel/admin')}}" class="fa fa-arrow-circle-o-left"></a>Cadastrar Admin Escola</h2>
    </div>
    <!-- END PAGE TITLE -->                
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Cadastrar</strong> Admin Escola</h3>
                        ...
                        <div class="panel-body">     
                            ...
                            <div class="form-group">                                        
                                <label class="col-md-3 col-xs-12 control-label">Admin Escola</label>
                        ...
                        <div class="panel-footer">
                            <a href="{{url('http://localhost/SAGE/panel/school_admin/create')}}" class="btn btn-default">Limpar infs</a>                                    
