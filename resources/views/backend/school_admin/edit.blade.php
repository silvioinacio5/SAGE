...
@section('content')
    ...
    <div class="page-title">                    
        <h2><a href="{{url('http://localhost/SAGE/panel/school_admin')}}" class="fa fa-arrow-circle-o-left"></a>Editar Admin Escola</h2>
    </div>
    <!-- END PAGE TITLE -->                
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Editar</strong> Admin Escola</h3>
                        ...
                        <div class="panel-body">                                                                        
                            ...
                            <div class="form-group">
                                <label class="col-md-3 col-xs-12 control-label">Nome Admin Escola<strong style="color: red">*</strong></label>
                        ...
                        <div class="panel-footer">
                            <a href="{{url('http://localhost/SAGE/panel/school_admin/edit'.$getSchool->id)}}" class="btn btn-default">Limpar infs</a>                                    
